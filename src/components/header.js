    ...
    render() {
        ...
        <Navbar collapseOnSelect expand="lg" >
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav.Link style={{color:'white'}} href={process.env.PUBLIC_URL +"/projects"}>Games</Nav.Link>
                <Nav.Link style={{color:'white'}} href={process.env.PUBLIC_URL +"/interests"}>Engage</Nav.Link>
